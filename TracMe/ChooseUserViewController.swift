...
class ChooseUserViewController: UIViewController {
    ...
    @IBAction func search(sender: AnyObject) {
        ...
        var ifSearch = self.searchBar.text
        var ifSearchBool = true
        ifSearch = ifSearch!.stringByReplacingOccurrencesOfString(".", withString: "t", options: NSStringCompareOptions.LiteralSearch, range: nil)
        var carlos = Firebase(url: "https://vivid-torch-4452.firebaseio.com/"+ifSearch!);
